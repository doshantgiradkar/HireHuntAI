// components/CompanyProfileForm.jsx
"use client"
...
const HIRING_MODELS = ["Remote", "Hybrid", "On-site"]
...
export default function CompanyProfileForm({  initialData = null,
  ...
  const [formData, setFormData] = useState({
    ...
    admin: {
      ...
      timezone: initialData?.admin?.timezone || "",
      location: initialData?.admin?.location || "",
      status: initialData?.admin?.status || "Active"
    }
  })
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6 px-4 py-4">
      <Card>
        <CardHeader>
          <CardTitle>{mode === "create" ? "Create Company Profile" : "Edit Company Profile"}</CardTitle>
          <CardDescription>
            {mode === "create" 
        ...
        <CardContent className="space-y-6">
          ...
          <div className="space-y-2">
            <Label htmlFor="overview">Company Overview <span className="text-destructive">*</span></Label>
            <Textarea
              id="overview"
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Additional company information and preferences</CardDescription>
        </CardHeader>
        <CardContent className="space-y-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="space-y-2">
            ...
            <div className="space-y-2">
              <Label htmlFor="headquarters">Headquarters Location <span className="text-destructive">*</span></Label>
              <Input
                id="headquarters"
            ...
            <div className="space-y-2">
              <Label htmlFor="founded">Founded Year <span className="text-destructive">*</span></Label>
              <Input
                id="founded"
            ...
            <div className="space-y-2">
              <Label htmlFor="companyType">Company Type <span className="text-destructive">*</span></Label>
              <Select value={formData.companyType} onValueChange={(value) => handleInputChange("companyType", value)} required>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Add the main roles your company typically hires for</CardDescription>
        </CardHeader>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Company contact details for candidates</CardDescription>
        </CardHeader>
        <CardContent className="space-y-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="space-y-2">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Primary administrator responsible for managing this company profile</CardDescription>
        </CardHeader>
        <CardContent className="space-y-6">
          <div className="flex items-center gap-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="space-y-2">
              <Label htmlFor="adminRole">Admin Role <span className="text-destructive">*</span></Label>
              <Input
                id="adminRole"
            ...
            <div className="space-y-2">
              <Label htmlFor="adminPhone">Admin Phone <span className="text-destructive">*</span></Label>
              <Input
                id="adminPhone"
                type="tel"
