  ...
  const handleSocialSignUp = async (provider) => {
    ...
    try {
      await signUp.authenticateWithRedirect({
        strategy: provider,
        redirectUrl: '/selectRole', // Redirect to selectRole after social signup
      });
    } catch (err) {
      setError(err.errors?.[0]?.message || err.message || 'Social signup failed');
    }
  };
